...
```bash
gh issue list --repo peviitor-scrapers/qualitest-dc-ro-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "QUALITEST", not the old template
