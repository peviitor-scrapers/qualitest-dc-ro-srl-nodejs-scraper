...
```bash
# Clone your fork
git clone https://github.com/sebiboga/qualitest-dc-ro-srl-nodejs-scraper.git
...
Open a [GitHub Issue](https://github.com/sebiboga/qualitest-dc-ro-srl-nodejs-scraper/issues) with:
